				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Persentase Adopsi Hewan</h3>
							...
							<div class="row">
								...
								<div class="col-md-3">
									...
									<div class="weekly-summary text-right">
										...
										<span class="info-label">Kunjungan Tiap Bulan</span>
									</div>
									<div class="weekly-summary text-right">
								...
								<div class="panel-body">
									<ul class="list-unstyled todo-list">
										<li>
											...
											<p>
												<span class="title">Perbaikan Server</span>
												<span class="short-description">Perbaikan server penjualan dan database pet shop.</span>
										...
										<li>
											...
											<p>
												<span class="title">Pengiriman 12 Kucing Ke Jakarta</span>
												<span class="short-description">Pengiriman 12 kucing anggora ke jakarta melalui dinas lingkungan.</span>
										...
										<li>
											...
											<p>
												<strong>Meeting dengan owner bodycare pet</strong>
												<span class="short-description">Pertemuan dilakukan di hotel gajahmada.</span>
